 ...
 * std_vector.i
 *
 * Overrrides the typemap from the SWIG library to replace the ICollection constructor parameter 
 * with IEnumerable<T>. This provides more flexibility and avoids boxing and unboxing in the foreach loop. 
 * 
 * This file can be removed from this project once this change has been integrated in the SWIG 
